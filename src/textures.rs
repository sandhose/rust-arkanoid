...
pub enum BallSprite {Ball1, Ball2, Ball3, Ball4, Ball5, Ball6}

pub enum VesselSprite {Size1, Size2, Size3, Size4, Size5, Size6, Size7, Size8}

pub enum PowerUpSprite {Rot1, Rot2, Rot3, Rot4, Rot5, Rot6, Rot7, Rot8}
pub enum PowerUpType {S, C, L, E, D, B, P}
...
pub enum RocketSprite {Yellow, Blue}

pub enum PropsSprite {
    Cone1, Pyramid1, Molecule1, Molecule17,
    Explosion1, Cone2, Pyramid2, Molecule2,
    Molecule18, Explosion2, Cone3, Pyramid3,
    Molecule3, Molecule19, Explosion3, Cone4,
    Pyramid4, Molecule4, Molecule20, Explosion4,
    Cone5, Pyramid5, Molecule5, Molecule21, Explosion5,
    Cone6, Pyramid6, Molecule6, Molecule22, Explosion6,
    Cone7, Pyramid7, Molecule7, Molecule23, Cone8,
    Pyramid8, Molecule8, Molecule24, Pyramid9,
    Pyramid10, Pyramid11, Molecule9, Molecule10, Molecule11,
    Molecule12, Molecule13, Molecule14, Molecule15, Molecule16,
}
...
impl TextureMaker {
    pub fn brick(sprite: BrickSprite, dst: Rect) -> CopyTool {
        ...
        let x = match sprite {
            ...
            BrickSprite::Blue
                | BrickSprite::Red
                | BrickSprite::Silver5
                | BrickSprite::Gold5 => xt[4],
            BrickSprite::Green
                | BrickSprite::Cyan
                | BrickSprite::Silver6
                | BrickSprite::Gold6 => xt[5],
        };
        let y = match sprite {
            BrickSprite::White
                | BrickSprite::Orange
    ...
    pub fn background(sprite: BackgroundSprite, dst: Rect) -> CopyTool {
        ...
        let x = match sprite {
            BackgroundSprite::Polygon
                | BackgroundSprite::PolygonDark => xt[0],
            BackgroundSprite::Blue
                | BackgroundSprite::BlueDark => xt[1],
            BackgroundSprite::Green
                | BackgroundSprite::GreenDark => xt[2],
            BackgroundSprite::Red
                | BackgroundSprite::RedDark => xt[3],
            BackgroundSprite::Orange
                | BackgroundSprite::OrangeDark => xt[4],
            BackgroundSprite::Purple
                | BackgroundSprite::PurpleDark => xt[5],
        };
        let y = match sprite {
            BackgroundSprite::Polygon
                | BackgroundSprite::Blue
    ...
    pub fn props(sprite: PropsSprite, dst: Rect) -> CopyTool {
        ...
        let y = match sprite {
            ...
            PropsSprite::Pyramid9
                | PropsSprite::Molecule9 => yt(8),
            PropsSprite::Pyramid10
                | PropsSprite::Molecule10 => yt(9),
            PropsSprite::Pyramid11
                | PropsSprite::Molecule11 => yt(10),
